...
//this responds a Profile 
app.get('/Cayanan', function (req, res) {
    console.log("Got a GET request for /Cayanan");
    res.send("This is my page profile for Andrew Cayanan the greatest baller of all time!");
})
